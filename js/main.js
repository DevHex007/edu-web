...
function testimonialSlider(){
    ...
    if(carouselOne){/** if element exists */
...
function headerMenu() {
    ...
    menu.addEventListener('click', (event) => {
        ...
        if(target.classList.contains('js-toggle-sub-menu') && window.innerWidth <= menuCollapseBreakpoint) {
            //this is to prevent the default anchor click behavior
            ...
            //if not already expanded...   exacute below codes

            //collapse the other expand menu-item
            if(menu.querySelector('.active')) {
                collapse();
            }

            //expand nav menu-item
...
function themeColor() {
    ...
    function setColor() {
        ...
        document.querySelector('[data-js-theme-color = ' + localStorage.getItem('color') + ']').classList.add
        ('active');
    }
